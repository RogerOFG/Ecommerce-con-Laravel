...
@section('content')
    <main class="main">
        <h2 class="main__ttl">Administra tus direcciones</h2>
            ...
            <div class="content">
                ...
                @if (!$shipments->isEmpty())
                    @foreach ($shipments as $shipment)
                        <a href="{{ route('editAddress', $shipment->id) }}" class="content__element">
                            <div class="content__logo">
                                <i class="content__icon bi bi-geo"></i>
                            </div>

                            <div class="content__txt">
                                <h3 class="content__sub">{{ str_replace(['[', ']'], '', $shipment->address) }}</h3>
