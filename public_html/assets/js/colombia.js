...
function cargarDepartamentos() {
    ...
    inputDepartamentos.addEventListener('input', function(event) {
        ...
        if (!hayCoincidencia && texto.trim() !== '') {
            ...
            inputDepartamentos.classList.remove('inputs__text--error');
        }
    });
...
function cargarCiudades(ciudades) {
    ...
    inputCiudades.addEventListener('input', function(event) {
        ...
        if (!hayCoincidencia && texto.trim() !== '') {
            ...
            inputCiudades.classList.remove('inputs__text--error');
        }
    });
}
...
document.addEventListener('DOMContentLoaded', function() {
    function controlarElemento(input, div) {
        input.addEventListener('click', function() {
            div.classList.remove('inputs__select--hidde');
        });

        const opciones = div.querySelectorAll('.inputs__option');
        opciones.forEach(function(opcion) {
            opcion.addEventListener('click', function() {
                div.classList.add('inputs__select--hidde');
            });
        });

        document.addEventListener('click', function(event) {
            if (!div.contains(event.target) && event.target !== input) {
                div.classList.add('inputs__select--hidde');
            }
        });
    }
    ...
    const inputDepartamentos = document.getElementById('departamentos');
    const divDepartContent = document.getElementById('departContent');
    controlarElemento(inputDepartamentos, divDepartContent);

    const inputCiudades = document.getElementById('ciudades');
    const divCiudades = document.getElementById('ciudContent');
    controlarElemento(inputCiudades, divCiudades);
});

function newAddress(){
    const input = document.getElementById('addressInput');
    const type = document.getElementById('typeStreet').value;
    const street = document.getElementById('streetNum').value;
